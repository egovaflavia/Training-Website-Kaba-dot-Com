...
$sql = mysqli_query($koneksi, "SELECT * FROM tbl_berita a left join tbl_kategori b on a.id_kategori=b.id_kategori left join tbl_penulis c on a.id_penulis=c.id_penulis WHERE DATE_FORMAT(tgl,'%Y')='$year'");
$no = 1;
?>
